...
/usr/sbin/ntpdate -sub <%= @host.params["ntp-server"] || "10.168.0.2" %>
...
[rhel-7.0]
name=rhel7.0
baseurl=http://10.168.0.2:81/repos/rhel7/rhel-x86_64-server-7/
gpgcheck=0
enabled=1

[rhel-7-server-openstack-5.0-rpms]
name=rhel-7-server-openstack-5.0-rpms
baseurl=http://10.168.0.2:81/repos/rhel7/rhel-7-server-openstack-5.0-rpms/
gpgcheck=0
enabled=1

[rhel-7-server-rh-common-rpms]
name=rhel-7-server-rh-common-rpms
baseurl=http://10.168.0.2:81/repos/rhel7/rhel-7-server-rh-common-rpms/
gpgcheck=0
enabled=1

[ceph-rhel7]
name=ceph-rhel7
baseurl=http://10.168.0.2:81/repos/rhel7/ceph-rhel7/
gpgcheck=0
enabled=1

[ceph-noarch-rhel7]
name=ceph-noarch-rhel7
baseurl=http://10.168.0.2:81/repos/rhel7/ceph-noarch-rhel7/
gpgcheck=0
enabled=1

[rhel-ha-for-rhel-7-server-rpms]
name=rhel-ha-for-rhel-7-server-rpms
baseurl=http://10.168.0.2:81/repos/rhel7/rhel-ha-for-rhel-7-server-rpms/
gpgcheck=0
enabled=1
...
IPAPPEND 2
kernel <%= @kernel %>
append initrd=<%= @initrd %> ks=<%= foreman_url("provision")%> biosdevname=0 ksdevice=bootif network kssendmac root=live:http://10.168.0.2:81/repos/squashfs.img looptype=squashfs
'
bbb='
default linux
label linux
...
os = Operatingsystem.where(:name => "RedHat", :major => "7", :minor => "0").first
os ||= Operatingsystem.create(:name => "RedHat", :major => "7", :minor => "0")
os.type = "Redhat"
os.description = "RHEL Server 7.0" if os.respond_to? :description=
os.save!
...
m.path="http://10.168.0.2:81/repos/rhel7/rhel-x86_64-server-7/"
m.os_family="Redhat"
...
params = {
  ...
  "ceilometer_metering_secret"    => "12345678",
  "ceilometer_user_password"      => "12345678",
  "cinder_db_password"            => "12345678",
  "cinder_user_password"          => "12345678",
  ...
  "cinder_eqlx_chap_password"     => ["12345678"],
  ...
  "glance_db_password"            => "12345678",
  "glance_user_password"          => "12345678",
  ...
  "heat_auth_encryption_key"      => "12345678",
  "heat_db_password"              => "12345678",
  "heat_user_password"            => "12345678",
  "heat_cfn_user_password"        => "12345678",
  "heat_auth_encrypt_key"         => "12345678",
  "horizon_secret_key"            => "12345678",
  "keystone_admin_token"          => "12345678",
  "keystone_db_password"          => "12345678",
  "keystone_user_password"        => "12345678",
  "mysql_root_password"           => "redhat",
  "neutron_db_password"           => "12345678",
  "neutron_user_password"         => "12345678",
  "nova_db_password"              => "12345678",
  "nova_user_password"            => "12345678",
  "nova_default_floating_pool"    => 'nova',
  "swift_admin_password"          => "12345678",
  "swift_shared_secret"           => "12345678",
  "swift_user_password"           => "12345678",
  ...
  "controller_admin_host"         => '10.168.0.10',
  "controller_priv_host"          => '10.168.0.10',
  "controller_pub_host"           => '10.168.0.10',
  "mysql_host"                    => '10.168.0.10',
  "mysql_virtual_ip"              => '10.168.0.10',
  "mysql_bind_address"            => '0.0.0.0',
  "mysql_virt_ip_nic"             => 'br-eth0',
  ...
  "mysql_clu_member_addrs"        => '10.168.0.3 10.168.0.4 10.168.0.5',
  "amqp_provider"                 => 'rabbitmq',
  "amqp_host"                     => '10.168.0.10',
  "amqp_username"                 => 'openstack',
  "amqp_password"                 => '12345678',
  "admin_email"                   => "admin@#{Facter.value(:domain)}",
  "neutron_metadata_proxy_secret" => '12345678',
  "enable_ovs_agent"              => "true",
  "ovs_vlan_ranges"               => '3100:3899',
  "ovs_bridge_mappings"           => ['physnet1:br-eth0','physnet2:br-eth1','physnet3:br-eth2','physnet4:br-ex'],
  "ovs_bridge_uplinks"            => [],
  "tenant_network_type"           => 'vlan',
  "enable_tunneling"              => 'False',
  "ovs_vxlan_udp_port"            => '4789',
  "ovs_tunnel_types"              => ['vlan'],
  ...
  "amqp_nssdb_password"           => '12345678',
  "fence_xvm_key_file_password"   => '12345678',
  "secret_key"                    => '12345678',
  ...
  "ceph_fsid"                     => "f11240d4-86b1-49ba-aacc-6d3d37b24cc4",
  ...
  "ntp_server1" 		  => "192.168.52.2",
  "ntp_server2" 		  => "10.168.0.2",
}

hostgroups = [
    {:name=>"CMRI OSP Installer",
     :class=>"quickstack::osp_installer"},
    {:name=>"CMRI Controller (Neutron)",
     :class=>"quickstack::neutron::ha_controller"},
    {:name=>"CMRI Compute (Neutron)",
     :class=>"quickstack::neutron::ha_compute"},
    {:name=>"CMRI Neutron Networker",
